...
const faqs = [
  ...
  },
  {
    ...
    a: "Да, вы можете сделать апгрейд или изменить пакет не позднее, чем за неделю до мероприятия.",
  },
  {
    q: "Работаете ли вы за пределами Краснодарского края?",
    a: "Мы работаем только по Краснодарскому краю.",
  },
];
